...
public class KAPinField : UITextField {
    ...
    public var ka_numberOfCharacters: Int = 6 {
        didSet {
    ...
    public var ka_font : KA_MonospacedFont? = .menlo(36){
        didSet{
            self.setupUI()
        }
    }
    ...
    private func checkCodeValidity() {
        if self.invisibleText.count == self.ka_numberOfCharacters || self.invisibleText.count == self.ka_numberOfCharacters - 1 {
